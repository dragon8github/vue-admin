<template>
    <div class="ht-upload">
        <el-container>
            <!-- 左侧菜单栏 -->
            <el-aside>
                <el-button class="change-status-btn"
                           type="primary"
                           icon="fa fa-sitemap"
                           @click="openAlltree"> 文档类型</el-button>
                <el-tree :data="data"
                         :props="defaultProps"
                    ...
                    <div class="upload-btn">
                        <el-button-group class="left">
                            <el-button type="primary"
                                       @click="active=1"
                                       icon="fa fa-upload"> 上传文件</el-button>
                            <el-button type="primary"
                                       @click="active=2"
                                       icon="fa fa-eye"> 查看所有附件</el-button>
                        </el-button-group>
                        <span class="right">
                            <!-- 全选 -->
                            ...
                            <el-button type="danger"
                                       icon="el-icon-delete"
                                       @click="deleteCheckedUploads">删除</el-button>
                        </span>
                    </div>
    ...
    sons: [
      {
        ...
        files: [
          {
            url: 'http://10.110.1.79/file/1.png',
            title: '1',
            ext: 'png',
            docID: '5515',
            isSending: true
          ...
          {
            url: 'http://pic13.nipic.com/20110322/6922092_142423354124_2.jpg',
            title: '1',
            ext: 'png',
            docID: '555',
            isSending: true
        ...
        sons: [
          {
            ...
            files: [
              {
                url:
                  'http://himg2.huanqiu.com/attachment2010/2012/1023/20121023034413313.jpg',
                title: '1',
                ext: 'jpg',
                docID: '1141',
                isSending: false
              ...
              {
                url:
                  'http://pic38.nipic.com/20140114/13563153_210444192122_2.jpg',
                title: '2',
                ext: 'png',
                docID: '2222',
                isSending: true
          ...
          },
          {
            ...
            files: [
              {
                url: 'http://img15.3lian.com/2015/f3/16/d/172.jpg',
                title: '3',
                ext: 'jpg',
                docID: '3343',
                isSending: false
      ...
      },
      {
        ...
        files: [
          {
            url:
              'http://img.sj33.cn/uploads/allimg/201105/20110517102640829.jpg',
            title: '1',
            ext: 'jpg',
            docID: '33123',
            isSending: false
    ...
    sons: [
      {
        ...
        files: [
          {
            url: 'http://10.110.1.79/file/2.png',
            title: '2',
            ext: 'png',
            docID: '412344',
            isSending: true
        ...
        sons: [
          {
            ...
            files: [
              {
                url:
                  'http://pic.baike.soso.com/p/20130921/20130921113932-1425927050.jpg',
                title: '1',
                ext: 'png',
                docID: '134611',
                isSending: false
              ...
              {
                url: 'http://pic21.nipic.com/20120609/22411_142849182156_2.jpg',
                title: '4',
                ext: 'png',
                docID: '222764',
                isSending: true
          ...
          },
          {
            ...
            files: [
              {
                url:
                  'http://pic15.nipic.com/20110728/2531170_220558291173_2.jpg',
                title: '1',
                ext: 'png',
                docID: '3123133',
                isSending: false
      ...
      },
      {
        ...
        files: [
          {
            url: 'http://pic15.nipic.com/20110728/2531170_220558291173_2.jpg',
            title: '1',
            ext: 'png',
            docID: '51232355',
            isSending: true
      ...
      },
      {
        ...
        files: [
          ...
          {
            url: 'http://10.110.1.79/file/test.docx',
            title: 'test',
            ext: 'docx',
            docID: '99913',
            isSending: true
...
export default {
  ...
  methods: {
    ...
    beforeAvatarUpload(file) {
      ...
      let fileType = /\.(gif|jpg|jpeg|png|xls|xlsx|xlsm|doc|docx|ppt|pptx|zip|rar|7z|cab|pdf)$/.test(
        file.name
      );
