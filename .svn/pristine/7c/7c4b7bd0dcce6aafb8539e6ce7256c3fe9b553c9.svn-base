  ...
  <div class="tags-outer-scroll-con">
    <div class="tags-inner-scroll-body">
      <el-tabs v-model="curTabName" type="card" @tab-remove="removeTab">
        <el-tab-pane v-for="(item, index) in showTabsArray" :key="item.name" :closable="item.name === '/admin/welcome' ? false : true" :label="item.title" :name="item.name">
